...
languages = {
    'ru': {
        'welcome': 'Добро пожаловать в официальный бот для отзывов "Iposuda"! 🍽️\n\nВыберите удобный язык общения:',
    ...
    'kz': {
        'welcome': '"Iposuda" ресмий пікірлер ботына қош келдіңіз! 🍽️\n\nСөйлесу тілін таңдаңыз:',
    ...
    'uz': {
        'welcome': '"Iposuda"ning rasmiy fikr-mulohazalar botiga xush kelibsiz! 🍽️\n\nMuloqot tilini tanlang:',
